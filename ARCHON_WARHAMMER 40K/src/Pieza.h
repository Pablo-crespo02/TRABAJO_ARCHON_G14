...
public:
    ...
    float multiplicadorArena = 1.0f; // Unificado aquí con valor por defecto
    ...
    // Métodos Virtuales Puros: Obligan a las hijas a implementarlos
    ...
    // Hechizos y control de Minions (Virtuales con comportamiento por defecto)
